...
w3 = Web3(
    Web3.HTTPProvider("https://sepolia.infura.io/v3/6cd55f78bad44ca392e3feea59b6435d")
)
...
while True:
    try:
        ...
        for event in events:
            ...
            payload = {"orderId": orderId, "status": "payed", "orderPayed": True}
            headers = {
                "Authorization": f"Bearer {auth_token}",
                "Content-Type": "application/json",
            }
            requests.post(API_ORDER_SAVE, json=payload, headers=headers)
